...
export const POST_PAGINATION_CONTEXT_KEY = 'postPagination';
...
export const COLLECTION_PAGE_CONTEXT_KEY = 'collectionsPage';
export const ORIGINAL_COLLECTION_PAGE_CONTEXT_KEY = 'originalCollectionsPage';
