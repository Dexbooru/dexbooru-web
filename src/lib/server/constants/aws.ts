...
export const AWS_UPLOAD_ARTIFACTS_BUCKET_NAME = dev
...
export const AWS_LOCAL_UPLOAD_ARTIFACTS_BASE_URL = `${AWS_S3_LOCAL_ENDPOINT}/${AWS_UPLOAD_ARTIFACTS_BUCKET_NAME}`;
